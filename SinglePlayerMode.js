...
export default function SinglePlayerMode({navigation,route}) {
  ...
  const [isModalVisible, setModalVisible] = useState(''); //modalC
  ...
  function ChoessAnswer(FinalAnswer) {
    ...
    if (FinalAnswer == correctAnswer) {
      ...
      ><View style={{backgroundColor:'#e9403e',justifyContent: "center",opacity:0.9,
         ...
         <Text style={{opacity:1,marginBottom:20, fontSize: 20,textAlign:'center',fontWeight: "bold", fontStyle: "normal",color:'#4C5784'}}> الاجابة الصحيحة هي ({choices[correctAnswer]})</Text>
         </View>
        </View>);
        setfeedback(true);
...
// // useEffect(() => {
// // if(sb1==0) setStyleb1(styles.button)
// // if(sb2==0) setStyleb2(styles.button)
// // if(sb3==0) setStyleb3(styles.button)
// // if(sb4==0) setStyleb4(styles.button)

// // if(sb1==1) setStyleb1(styles.buttonc)
// // if(sb2==1) setStyleb2(styles.buttonc)
// // if(sb3==1) setStyleb3(styles.buttonc)
// // if(sb4==1) setStyleb4(styles.buttonc)

// // if(sb1==-1) setStyleb1(styles.buttonr)
// // if(sb2==-1) setStyleb2(styles.buttonr)
// // if(sb3==-1) setStyleb3(styles.buttonr)
// // if(sb4==-1) setStyleb4(styles.buttonr)
...
// //       playSound('wrong');
// //       setModalVisible(false);
// //       if (correctAnswer === 0)    global.sb1=1;
// //       if (correctAnswer === 1)     global.sb2=1;
// //       if (correctAnswer === 2)      global.sb3=1;
// //       if (correctAnswer === 3)     global.sb4=1;
