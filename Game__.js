...
export default function Game({ navigation, route }) {
  ...
  const [modalR, setModalR] = useState('');
  ...
  const [playersicons, setplayersicons] = useState(null);

  const [Player1icon,setPlayer1icon]=useState(0);
  const [Player2icon,setPlayer2icon]=useState([]);
  const [Player3icon,setPlayer3icon]=useState([]);
  const [Player4icon,setPlayer4icon]=useState([]);


  // state={c1:0,c2:0,c3:0,c4:0}
 ...
 const iconColor = ['red','blue', 'black'];
 /*  useEffect(() => {
   for (let index = 0; index < Players.length; index++) {
    setplayersicons([...playersicons,index])
...
*/
  ...
  useEffect(
    async () =>
      onSnapshot(doc(db, "Game", IDToBeSent), (snapshot) =>
      setModalR(snapshot.data().Validate)
      ),
      []
  );
  // useEffect(
  ...
  useEffect(() => {
    ...
    if(modalR=='true'){
      ...
      ><View style={{//chn color shosho,
      backgroundColor:'#8DC3A7',justifyContent: "center",opacity:0.9,
          alignItems: "center",height:138,width:440, paddingTop:15,paddingLeft:15,paddingRight:15,marginBottom:100}}>
         <Text style={{opacity:1,marginBottom:20, fontSize: 20,textAlign:'center',fontWeight: "bold", fontStyle: "normal",color:'#4C5784'}}>الاجابة صحيحة!</Text>
         </View>
        </View> )
      setfeedback(true); 
    }
    else if(modalR=='false'){
        setfeedback(true);
    }
else if(modalR==''){
  setfeedback(false);
}
  }, [ExplorerModal, QuestionModal,modalR]);
  //---------------------------------------------------------------------joud Char
  let joudCharPlayer1 = [
    " ",
    " ",
  ...
  if (Players != undefined) {
    ...
    if (Players.length == 3) {
      ...
      joudCharPlayer3[Players[2].Position] = (
        <Image
          source={require("../../../../assets/Joud4.png")}
          style={{ width: 45, height: 45, resizeMode: "contain" }}
        />
      );
    }
  ...
  const getQuestion = async () => {
    ...
    qac = QuestionList[Math.floor(Math.random() * randoma.length)];
    await updateDoc(doc(db, "Game", IDToBeSent), {
      CurrentQuestion: qac,
    });
    //  setQuestion(qac[4]);
  ...
  async function ChoessAnswer(FinalAnswer) {
    ...
    ModalC('Question', Player_Answer1.length, Player_Answer2.length,Player_Answer3.length,Player_Answer4.length)
    if (
    ...
    // }, 2000);  
      ...
      ><View style={{backgroundColor:'#e9403e',justifyContent: "center",opacity:0.9,
          alignItems: "center",height:138,width:440, paddingTop:15,paddingLeft:15,paddingRight:15,marginBottom:100}}>
         <Text style={{opacity:1,marginBottom:20, fontSize: 20,textAlign:'center',fontWeight: "bold", fontStyle: "normal",color:'#4C5784'}}>الاجابة خاطئة</Text> 
         <Text style={{opacity:1,marginBottom:20, fontSize: 20,textAlign:'center',fontWeight: "bold", fontStyle: "normal",color:'#4C5784'}}> الاجابة الصحيحة هي ({currentq[1].Choices[currentq[0]]})</Text>
         </View>
        </View>);
        await updateDoc(doc(db, "Game", IDToBeSent), {
          Validate:'false',
  ...
  async function ChoessExplorer(FinalExplorer) {
    ...
    await getDoc(Ref)
      ...
      ModalC('Explorer',  Player_Explorer1.length,  Player_Explorer2.length,  Player_Explorer3.length)
    if (
 ...
 function icons(type) {
  switch (type) {
    case 1: 
    if(Players[0].Email==user.email)
    {  setPlayer1icon(...Player1icon,<Image style={{width: 45,height: 45 ,left:'60%',bottom:8}} source={require("../../../../assets/Joudy.png")} />)}
    if(Players[1].Email==user.email)
     { setPlayer1icon(...Player1icon, <Image style={{width: 45,height: 45 ,left:'60%',bottom:8}} source={require("../../../../assets/joudBc.png")} />)}
    if(Players[2].Email==user.email)
     {setPlayer1icon(...Player1icon,<Image style={{width: 45,height: 45 ,left:'60%',bottom:8}} source={require("../../../../assets/JoudP4.png")} />)}
    ; break;
    case 2: ; 
    if(Players[0].Email==user.email)
    {  setPlayer2icon(...Player2icon,<Image style={{width: 45,height: 45 ,left:'60%',bottom:8}} source={require("../../../../assets/Joudy.png")} />)}
    if(Players[1].Email==user.email)
     { setPlayer2icon(...Player2icon, <Image style={{width: 45,height: 45 ,left:'60%',bottom:8}} source={require("../../../../assets/joudBc.png")} />)}
    if(Players[2].Email==user.email)
     {setPlayer2icon(...Player2icon,<Image style={{width: 45,height: 45 ,left:'60%',bottom:8}} source={require("../../../../assets/JoudP4.png")} />)}
    break;
    case 3: 
    if(Players[0].Email==user.email)
    {  setPlayer3icon(...Player3icon,<Image style={{width: 45,height: 45 ,left:'60%',bottom:8}} source={require("../../../../assets/Joudy.png")} />)}
    if(Players[1].Email==user.email)
     { setPlayer3icon(...Player3icon, <Image style={{width: 45,height: 45 ,left:'60%',bottom:8}} source={require("../../../../assets/joudBc.png")} />)}
    if(Players[2].Email==user.email)
     {setPlayer3icon(...Player3icon,<Image style={{width: 45,height: 45 ,left:'60%',bottom:8}} source={require("../../../../assets/JoudP4.png")} />)}; break;
    case 4: 
    if(Players[0].Email==user.email)
    {  setPlayer4icon(...Player4icon,<Image style={{width: 45,height: 45 ,left:'60%',bottom:8}} source={require("../../../../assets/Joudy.png")} />)}
    if(Players[1].Email==user.email)
     { setPlayer4icon(...Player4icon, <Image style={{width: 45,height: 45 ,left:'60%',bottom:8}} source={require("../../../../assets/joudBc.png")} />)}
    if(Players[2].Email==user.email)
     {setPlayer4icon(...Player4icon,<Image style={{width: 45,height: 45 ,left:'60%',bottom:8}} source={require("../../../../assets/JoudP4.png")} />)}; break;
  
  }
  }

  async function ModalC(Type,a1,a2,a3,a4) {
            ...
            {ActivePlayerName.map((item) => (
              <View style={styles.containerShowQ} key={item.Id}>
                ...
                >
                  ...
                  {item==ActivePlayerName[0]? 
                  <Text>{a1}</Text>:
                  null
                  }
                {item==ActivePlayerName[1]? 
                  <Text>{a2}</Text>:
                  null
                  }
                {item==ActivePlayerName[2]? 
                  <Text>{a3}</Text>:
                  null
                  }
                </Pressable>
                ...
                <Pressable
                  ...
                  onPress={async() => {
                    if (ActivePlayer.includes(user.email)) {
                      ...
                      //    Alert.alert(String(doc.get("Choice1").length)) ;}) 
...
{Players[0].Position!=-1?
  (<>
<View style={{left:'20%',bottom:-23}}>
<Text  style={styles.copyText3}>{Players[0].Name}</Text> 
</View>
<View style={{left:'25%',bottom:-20}}>
<Image style={{width: 45,height: 45 ,left:'60%',bottom:8}} source={require("../../../../assets/Joudy.png")} />
</View>
</>)
:null}
 {Players[1].Position!=-1?
  (<>
<View style={{left:'20%',bottom:-30}}>
<Text  style={styles.copyText4}>{Players[1].Name}</Text> 
</View>

<View style={{left:'25%',bottom:-30}}>
<Image style={{width: 45,height: 45 ,left:'60%',bottom:8}} source={require("../../../../assets/joudBc.png")} />
</View>
</>)
  :null}
</View>
  ...
  {Players[0].Position!=-1?
  (<>
  <View style={{left:'20%',bottom:8}}>
  <Text  style={styles.copyText3}>{Players[0].Name}</Text> 
  </View>
  <View style={{left:'25%',bottom:6}}>
  <Image style={{width: 45,height: 45 ,left:'60%',bottom:8}} source={require("../../../../assets/Joudy.png")} />
  </View>
  </>)
:null}
...
{Players[2].Position!=-1?
  (<>
  <View style={{left:'20%',bottom:-7}}>
  <Text  style={styles.copyText4}>{Players[2].Name}</Text> 
  </View>
  
  <View style={{left:'25%',bottom:-7}}>
  <Image style={{width: 45,height: 45 ,left:'60%',bottom:8}} source={require("../../../../assets/JoudP4.png")} />
  </View>
 </>)
:null}
  </View>
    ...
    <MenuProvider>
      ...
      <View style={{ flex: 1, backgroundColor: "#FFF7F0" }}>
        ...
        <Menu style={{ flex: 1, position: "absolute", top: 2 }}>
          ...
          <MenuOptions>
            <MenuOption onSelect={() => { playSound('pres'); navigation.navigate('Instruction2',{IDToBeSent}) }} text="تعليمات اللعبة" />
            <MenuOption
              onSelect={() => {
                playSound('pres'); Alert.alert(
                  "",
...
><View style={{//chn color shosho,
backgroundColor:'#8DC3A7',justifyContent: "center",opacity:0.8,
    alignItems: "center",height:138,width:440, paddingTop:15,paddingLeft:15,paddingRight:15,marginBottom:100}}>
   <Text style={{opacity:1,marginBottom:20, fontSize: 20,textAlign:'center',fontWeight: "bold", fontStyle: "normal",color:'#4C5784'}}>الاجابة صحيحة!</Text>
   </View>
  </View>:null}
...
>  
<View style={{backgroundColor:'#e9403e',justifyContent: "center",opacity:0.8,
    alignItems: "center",height:138,width:440, paddingTop:15,paddingLeft:15,paddingRight:15,marginBottom:100}}>
   <Text style={{opacity:1,marginBottom:20, fontSize: 20,textAlign:'center',fontWeight: "bold", fontStyle: "normal",color:'#4C5784'}}> اجابة خاطئة!  </Text>
   </View>
  </View>:null} */}
